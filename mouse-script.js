...
function onMouseHover() {
    console.log("mouseenterlink");
    for (var i = cursor.length - 1; i >= 0; i--) {
       
        var currentStyle = cursor.children[i].getAttribute("style");
        var newStyle = currentStyle + "width:50px;height:50px;";
        cursor.children[i].setAttribute("style",newStyle);
    }
...
function onMouseHoverOut() {
    ...
    for (var i = cursor.length - 1; i >= 0; i--) {
        cursor.children[i].style.width = "36px";
        cursor.children[i].style.height = "36px";
        cursor.children[i].style.transition = ".5s";
    }
}
class HoverButton {
    constructor(id) {
